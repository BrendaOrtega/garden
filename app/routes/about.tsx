      ...
      >
        ...
        >
          ...
          <Flex>
            ...
            >
              <Text color="text" fontSize={{ base: "md", lg: "lg" }}>
                {" "}
                ✉️ Write me{" "}
              </Text>
            </a>
            ...
            />
            <a
              href="https://firebasestorage.googleapis.com/v0/b/camp-92fe8.appspot.com/o/garden%2FCV-Brenda.pdf?alt=media&token=a53350aa-8c3e-4239-8209-babdfe03e6be"
              target="_blank"
            >
              <Text color="text" fontSize={{ base: "md", lg: "lg" }}>
                {" "}
